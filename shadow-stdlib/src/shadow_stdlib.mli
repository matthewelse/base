...
external raise : exn -> 'a @ unique portable @@ portable = "%reraise"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Stdlib.raise] instead"]

external raise_notrace : exn -> 'a @ unique portable @@ portable = "%raise_notrace"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
...
external ( ** ) : float -> float -> float @@ portable = "caml_power_float" "pow" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [**.] instead."]

external sqrt : float -> float @@ portable = "caml_sqrt_float" "sqrt" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external log10 : float -> float @@ portable = "caml_log10_float" "log10" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.log10] instead."]

external expm1 : float -> float @@ portable = "caml_expm1_float" "caml_expm1" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.expm1] instead."]

external log1p : float -> float @@ portable = "caml_log1p_float" "caml_log1p" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external acos : float -> float @@ portable = "caml_acos_float" "acos" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.acos] instead."]

external asin : float -> float @@ portable = "caml_asin_float" "asin" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.asin] instead."]

external atan : float -> float @@ portable = "caml_atan_float" "atan" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.atan] instead."]

external atan2 : float -> float -> float @@ portable = "caml_atan2_float" "atan2" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.atan2] instead."]

external hypot : float -> float -> float @@ portable = "caml_hypot_float" "caml_hypot" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.hypot] instead."]

external cosh : float -> float @@ portable = "caml_cosh_float" "cosh" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.cosh] instead."]

external sinh : float -> float @@ portable = "caml_sinh_float" "sinh" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.sinh] instead."]

external tanh : float -> float @@ portable = "caml_tanh_float" "tanh" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.tanh] instead."]

external acosh : float -> float @@ portable = "caml_acosh_float" "caml_acosh" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.acosh] instead."]

external asinh : float -> float @@ portable = "caml_asinh_float" "caml_asinh" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.asinh] instead."]

external atanh : float -> float @@ portable = "caml_atanh_float" "caml_atanh" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.atanh] instead."]

external ceil : float -> float @@ portable = "caml_ceil_float" "ceil" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.round_up] instead."]

external floor : float -> float @@ portable = "caml_floor_float" "floor" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external copysign : float -> float -> float @@ portable = "caml_copysign_float" "caml_copysign" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Float.copysign] instead."]

external mod_float : float -> float -> float @@ portable = "caml_fmod_float" "fmod" [@@unboxed] [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external ldexp : (float [@unboxed]) -> (int [@untagged]) -> (float [@unboxed]) @@ portable = "caml_ldexp_float" "caml_ldexp_float_unboxed" [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external classify_float : (float [@unboxed]) -> fpclass @@ portable = "caml_classify_float" "caml_classify_float_unboxed" [@@noalloc]
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external ignore_contended : 'a @ local once contended -> unit @@ portable = "%ignore"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
...
type nonrec in_channel : value mod contended portable = Stdlib.in_channel
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Use [Stdio.In_channel.t] instead."]

type nonrec out_channel : value mod contended portable = Stdlib.out_channel
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
...
external format_of_string : ('a, 'b, 'c, 'd, 'e, 'f) format6 -> ('a, 'b, 'c, 'd, 'e, 'f) format6 @@ portable = "%identity"
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Stdlib.format_of_string] instead"]

val ( ^^ ) : ('a, 'b, 'c, 'd, 'e, 'f) format6 -> ('f, 'b, 'c, 'e, 'g, 'h) format6 -> ('a, 'b, 'c, 'd, 'g, 'h) format6 @@ portable
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
There is not equivalent functionality in Base or Stdio at the moment,
so you need to use [Stdlib.( ^^ )] instead"]
...
module Safe = Stdlib.Safe
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Referring to the stdlib directly is discouraged by Base. You should either
use the equivalent functionality offered by Base, or if you really want to
refer to the stdlib, use Stdlib.Safe instead"]
...
module Modes = Stdlib.Modes 
[@@deprecated "\
[2016-09] this element comes from the stdlib distributed with OCaml.
Referring to the stdlib directly is discouraged by Base. You should either
use the equivalent functionality offered by Base, or if you really want to
refer to the stdlib, use Stdlib.Modes instead"]
